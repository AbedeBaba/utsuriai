...
export const translations: Translations = {
  ...
  // Jewelry
  'nav.jewelry': { en: 'Jewelry', tr: 'Takı' },
  'jewelry.pageTitle': { en: 'Jewelry Studio', tr: 'Takı Stüdyosu' },
  'jewelry.badge': { en: 'Jewelry-Focused AI', tr: 'Takı Odaklı AI' },
  'jewelry.title': { en: 'Select Body Part Preset', tr: 'Vücut Bölgesi Seçin' },
  ...
  'jewelry.uploadDesc': { en: 'Upload a clear, high-quality photo of your jewelry product. The AI will place it naturally on the selected body part.', tr: 'Takı ürününüzün net, yüksek kaliteli bir fotoğrafını yükleyin. AI seçilen vücut bölgesine doğal şekilde yerleştirecek.' },
  'jewelry.uploadRequired': { en: 'Please upload a jewelry image first', tr: 'Lütfen önce bir takı görseli yükleyin' },
  'jewelry.imageUploaded': { en: 'Jewelry image uploaded', tr: 'Takı görseli yüklendi' },
  'jewelry.changeImage': { en: 'Change Image', tr: 'Görseli Değiştir' },
  'jewelry.dragOrClick': { en: 'Drag & drop or click to upload', tr: 'Sürükle bırak veya tıkla' },
  'jewelry.supportedFormats': { en: 'PNG, JPG, WEBP supported', tr: 'PNG, JPG, WEBP desteklenir' },
  'jewelry.selectMode': { en: 'Select Quality', tr: 'Kalite Seçin' },
  'jewelry.standard': { en: 'Standard', tr: 'Standart' },
  'jewelry.standardDesc': { en: 'Good quality, fast generation', tr: 'İyi kalite, hızlı oluşturma' },
  'jewelry.pro': { en: 'Pro', tr: 'Pro' },
  'jewelry.proDesc': { en: 'Premium quality, higher detail', tr: 'Premium kalite, yüksek detay' },
  'jewelry.creditInfo': { en: 'Cost', tr: 'Maliyet' },
  'jewelry.generateButton': { en: 'Generate Jewelry Image', tr: 'Takı Görseli Oluştur' },
  'jewelry.generating': { en: 'Generating your jewelry image...', tr: 'Takı görseliniz oluşturuluyor...' },
  'jewelry.generationSuccess': { en: 'Jewelry image generated successfully!', tr: 'Takı görseli başarıyla oluşturuldu!' },
  'jewelry.generationFailed': { en: 'Generation failed. Please try again.', tr: 'Oluşturma başarısız oldu. Lütfen tekrar deneyin.' },
  'jewelry.result': { en: 'Result', tr: 'Sonuç' },
  'jewelry.download': { en: 'Download', tr: 'İndir' },
  'jewelry.regenerate': { en: 'Regenerate', tr: 'Yeniden Oluştur' },
  'jewelry.downloadStarted': { en: 'Download started', tr: 'İndirme başladı' },
  ...
  'jewelry.presets.handOnlyUseFor': { en: 'Rings, Statement Rings', tr: 'Yüzükler, Tasarım Yüzükler' },
  'jewelry.presets.handWrist': { en: 'Hand + Wrist', tr: 'El + Bilek' },
  'jewelry.presets.handWristDesc': { en: 'From mid-forearm to fingertips with balanced studio highlights', tr: 'Ön kol ortasından parmak uçlarına, dengeli stüdyo ışığıyla' },
  'jewelry.presets.handWristUseFor': { en: 'Bracelets, Charms, Watches', tr: 'Bileklikler, Uğurlar, Saatler' },
  'jewelry.presets.neckCloseup': { en: 'Neck Close-up', tr: 'Boyun Yakın Çekim' },
  'jewelry.presets.neckCloseupDesc': { en: 'Tight crop from chin to mid-neck with soft frontal light', tr: 'Çene altından boyun ortasına sıkı kırpım, yumuşak ön ışık' },
  'jewelry.presets.neckCloseupUseFor': { en: 'Chokers, Short Necklaces', tr: 'Chokerlar, Kısa Kolyeler' },
  'jewelry.presets.neckCollarbone': { en: 'Neck + Collarbone', tr: 'Boyun + Köprücük Kemiği' },
  'jewelry.presets.neckCollarboneDesc': { en: 'From lower chin to upper chest with diffused lighting', tr: 'Alt çeneden üst göğüse, yayılmış ışıkla' },
  'jewelry.presets.neckCollarboneUseFor': { en: 'Necklaces, Pendants', tr: 'Kolyeler, Kolye Uçları' },
  'jewelry.presets.singleEar': { en: 'Single Ear', tr: 'Tek Kulak' },
  'jewelry.presets.singleEarDesc': { en: 'Side profile with hair tucked back, side lighting for metal shine', tr: 'Saç arkaya toplanmış yan profil, metal parlaklığı için yan ışık' },
  'jewelry.presets.singleEarUseFor': { en: 'Earrings', tr: 'Küpeler' },
