...
export function FilterStepLayout({
  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <header className="flex items-center justify-between p-6">
        {showBack && onBack ? <Button variant="ghost" size="icon" onClick={onBack} className="text-white/80 hover:text-white hover:bg-white/10 border border-white/20 backdrop-blur-sm">
