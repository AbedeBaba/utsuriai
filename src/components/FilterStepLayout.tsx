...
export function FilterStepLayout({
  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <header className="flex items-center justify-between p-4 md:p-6">
        {showBack && onBack ? <Button variant="ghost" size="icon" onClick={onBack} className="relative text-white hover:text-white hover:bg-violet-500/30 border-2 border-white/50 backdrop-blur-xl rounded-xl transition-all duration-300 hover:border-violet-400 hover:shadow-[0_0_30px_rgba(139,92,246,0.4)] bg-black/30 w-11 h-11 shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
