...
export default function FilterGender() {
  ...
  return (
    <FilterStepLayout 
      ...
      onBack={() => navigate('/')}
    >
      {/* Male Model Photo - Left Edge */}
      <div 
        className={cn(
          "fixed left-0 top-0 h-full w-[30vw] overflow-hidden pointer-events-none z-0 transition-all duration-500",
          hoveredGender === 'Male' ? "opacity-100" : "opacity-40"
        )}
      >
        <img 
          src={maleModel} 
          ...
          className={cn(
            ...
            hoveredGender === 'Male' && "scale-110 brightness-110"
          )}
        />
        {/* Shine overlay */}
        <div 
      ...
      {/* Female Model Photo - Right Edge */}
      <div 
        className={cn(
          "fixed right-0 top-0 h-full w-[30vw] overflow-hidden pointer-events-none z-0 transition-all duration-500",
          hoveredGender === 'Female' ? "opacity-100" : "opacity-40"
        )}
      >
        <img 
          src={femaleModel} 
          ...
          className={cn(
            "h-full w-full object-cover object-center transition-all duration-500",
            hoveredGender === 'Female' && "scale-110 brightness-110"
          )}
        />
        {/* Shine overlay */}
        <div 
