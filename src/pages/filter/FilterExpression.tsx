...
export default function FilterExpression() {
  ...
  const handleRandomSingle = useCallback(() => {
    ...
    setIsAnimating(true);
    setSelectedId(randomExpression.id);
    setHoverDisabled(true);
  ...
  return (
    <FilterStepLayout 
      ...
      infoText={infoText}
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8 relative w-full max-w-7xl mx-auto px-4">
